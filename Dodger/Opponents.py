...
class Baddie():
    ...
    BADDIES = ['images/spurs.png', 'images/chelsea.png', 'images/manunited.png', 'images/mancity.png', 'images/liverpool.png']
    BADDIE = random.choice(BADDIES)
    BADDIE_IMAGE = pygame.image.load(BADDIE)

    def __init__(self, window):
        self.window = window
        # Create the image object
        size = random.randrange(Baddie.MIN_SIZE, Baddie.MAX_SIZE + 1)
        self.x = random.randrange(0, WIN_WIDTH - size)
