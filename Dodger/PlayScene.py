...
BOTTOM_RECT = (0, GAME_HEIGHT + 1, WIN_WIDTH,
...
class ScenePlay(pyghelpers.Scene):
    ...
    def __init__(self, window):
        ...
        self.background = pygwidgets.Image(self.window,
                                                   (0, GAME_HEIGHT),
                                                   'images/ucl.jpg')
        ...
        self.gameOverImage = pygwidgets.Image(self.window, (50, 200),
                                        'images/gameOver.png')
        ...
        self.oGoodieMgr = UCLMgr(self.window)
    ...
    def getHiAndLowScores(self):
        ...
        infoDict = self.request(SCENE_HIGH_SCORES, DATA_HIGH_SCORE)
    ...
    def update(self):
        ...
        if nGoodiesHit > 0:
            self.dingSound.play()
            self.score = self.score + (nGoodiesHit * UCL_POINTS)
        ...
        self.score = self.score + (nBaddiesEvaded * TEAMS_POINTS)
